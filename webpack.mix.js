...
mix
  ...
  .copy('src/videos/entrelomas_2_hd.webm', 'public_html/videos/')
  .copy('src/videos/entrelomas_2_sd.webm', 'public_html/videos/')
  .copy('src/videos/entrelomas_2_ld.webm', 'public_html/videos/')
  .copy('src/videos/entrelomas_2.mp4', 'public_html/videos/')
